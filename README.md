...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/torchvision-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/torchvision-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2087&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/torchvision-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.14.____cp314" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add torchvision torchvision-tests
# for installing globally
pixi global install torchvision torchvision-tests
```
...
It is possible to list all of the versions of `torchvision` available on your platform:
...
```
pixi search torchvision --channel conda-forge
```
